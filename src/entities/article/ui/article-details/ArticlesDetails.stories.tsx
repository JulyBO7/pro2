...
export const Loading = Template.bind({}) as typeof Template;
Loading.decorators = [StoreDecorator({ article: { isLoading: true } })];

export const Error = Template.bind({}) as typeof Template;
Error.decorators = [StoreDecorator({ article: { error: "Error" } })];

export const WitnContent = Template.bind({}) as typeof Template;
WitnContent.decorators = [StoreDecorator({
    article: {
        data:
    {
        id: "1",
